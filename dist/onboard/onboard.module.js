...
exports.OnboardModule = OnboardModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([onboard_conditions_entity_1.Onboard_conditions]),
        ...
        providers: [onboard_service_1.OnboardService, jwt_service_strategy_1.JwtServiceStrategy],
