...
export class GroupController {
    ...
    @UseGuards(JwtServiceAuthGuard)
    @Post('enterGroup')
    async enterGroup(@Body() body: SearchGroupDto, @Req() req, @Res() res){
        try {
    ...
    @UseGuards(JwtServiceAuthGuard)
    @Delete('deleteGroup')
    async deleteGroup(@Body() body: SearchGroupDto, @Req() req, @Res() res){
        try {
    ...
    @UseGuards(JwtServiceAuthGuard)
    @Post('forceLeader')
    async forceLeader(@Body() body: SearchGroupDto, @Req() req: Request, @Res() res){
    ...
    @Post('setLeader')
    async setLeader(@Body() body: SetLeaderDto, @Req() req: Request, @Res() res){
        try {
    ...
    @Delete('exitGroup')
    async exitGroup(@Body() body: SearchGroupDto, @Req() req: Request, @Res() res){
        try {
